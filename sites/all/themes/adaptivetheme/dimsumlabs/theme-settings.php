...
/**
 * USAGE:
 * 1 - To use this file replace "dimsumlabs" with the name of
...
// Replace 'dimsumlabs' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function dimsumlabs_form_system_theme_settings_alter(&$form, &$form_state)  {
