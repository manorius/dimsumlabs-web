 ...
 * 1. Rename each function and instance of "dimsumlabs" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "dimsumlabs".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within dimsumlabs_preprocess_html(), there
 ...
 */
function dimsumlabs_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'dimsumlabs.responsive.style.css',
    'dimsumlabs.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'dimsumlabs');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'dimsumlabs');
  // */
...
function dimsumlabs_process_html(&$vars) {
}
// */
...
function dimsumlabs_preprocess_page(&$vars) {
}

function dimsumlabs_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dimsumlabs_preprocess_node(&$vars) {
}

function dimsumlabs_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dimsumlabs_preprocess_comment(&$vars) {
}

function dimsumlabs_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dimsumlabs_preprocess_block(&$vars) {
}

function dimsumlabs_process_block(&$vars) {
}
// */
